...
feature "Replace walls" do
  ...
  scenario "when user selects walls that doesn't need permit (Only paint, wallpaper, etc.)" do
    ...
    # project#new
    check I18n.t('views.projects.new.project.wall')
    ...
    within "div.wall_general_changes" do
      choose I18n.t('views.project_steps.answer_screener.wall.options.yes_statement')
    end
    ...
    page.find('div.permit_not_needed').should have_content(I18n.t('models.project.wall.name'))
  ...
  scenario "when user selects walls that needs permit (Only paint, wallpaper, etc.)" do
    ...
    #project_steps#answer_screener
    within "div.wall_general_changes" do
      choose I18n.t('views.project_steps.answer_screener.wall.options.no_statement') 
    end
    ...
    #project_steps#display_permits
    page.find('div.permit_needed').should have_content(I18n.t('models.project.wall.name'))
